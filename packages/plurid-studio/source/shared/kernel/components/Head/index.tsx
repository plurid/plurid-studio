...
const Head: React.FC<HeadProperties> = (
    ...
    const titleValue = title || `plurid studio`;
    const descriptionValue = description || 'plurid studio';
    const ogTitleValue = ogTitle || title || `plurid studio`;
    const ogDescriptionValue = ogDescription || description || 'plurid studio';
    const ogImageValue = ogImage || '/icon-192x192.png';
    const ogURLValue = ogURL || 'https://plurid.studio';
